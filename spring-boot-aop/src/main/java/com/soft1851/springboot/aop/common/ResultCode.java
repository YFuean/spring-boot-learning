...
public enum ResultCode {
    ...
    SMS_ERROR(20010,"短信发送失败"),
    USER_NOT_EXIST(20006, "用户不存在"),
    USER_HAS_EXISTED(20007, "用户已存在"),
    USER_SIGN_UP_FAIL(20008,"用户注册失败"),
    USER_VERIFY_OVERDUE(20009,"验证码已过期"),
    USER_CODE_TIMEOUT(20011,"验证码失效"),
    DATABASE_ERROR(20012,"数据失败"),
    USER_NO_AUTH(20013,"用户权限不足"),
